...
<div class="card">
    ...
    <div class="card-body px-sm-5">
        ...
        <form action="/asal/update" method="post" class="text-center" style="color: #757575;" action="#!">
            ...
            <!-- E-mai -->
            <div class="md-form">
            <input value="<?php echo e($k -> nama); ?>" type="email" id="materialSubscriptionFormEmail" class="form-control">
