  ...
  <ul class="custom-scrollbar">
    ...
    <li>
      <ul class="collapsible collapsible-accordion">
        ...
        <li><a href="{{url('home')}}" class="collapsible-header waves-effect arrow-r"><i class="fas fa-home"></i>
            Beranda</a>
        </li>
      <li><a href="{{url('carapengunaan')}}"class="collapsible-header waves-effect arrow-r"><i class="fas fa-book"></i> Cara Penggunaan</a>
        </li>
